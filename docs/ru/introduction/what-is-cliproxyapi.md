...
**CLIProxyAPI** — это прокси-сервер, предоставляющий совместимые с OpenAI/Gemini/Claude/Codex интерфейсы API для CLI.
...
- Совместимые с OpenAI/Gemini/Claude эндпоинты API для моделей CLI
...
- Поддержка Qwen Code через вход по OAuth
- Поддержка iFlow через вход по OAuth
...
- Использование нескольких аккаунтов с балансировкой нагрузки round-robin (Gemini, OpenAI, Claude, Qwen и iFlow)
- Простые процессы аутентификации CLI (Gemini, OpenAI, Claude, Qwen и iFlow)
...
- Балансировка нагрузки между несколькими аккаунтами Qwen Code
- Балансировка нагрузки между несколькими аккаунтами iFlow
